...
class UpdateUserResponse {
  ...
  UpdateUserResponse.fromJson(dynamic json) {
    ...
    _result = json['result'] != null ? UpdateUserResult.fromJson(json['result']) : null;
  }
  String? _message;
  UpdateUserResult? _result;

  String? get message => _message;
  UpdateUserResult? get result => _result;
...
UpdateUserResult resultFromJson(String str) => UpdateUserResult.fromJson(json.decode(str));
String resultToJson(UpdateUserResult data) => json.encode(data.toJson());
class UpdateUserResult {
  ...
  UpdateUserResult.fromJson(dynamic json) {
