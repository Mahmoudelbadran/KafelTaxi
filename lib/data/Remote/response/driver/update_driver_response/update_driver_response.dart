import 'dart:convert';
UpdateDriverResponse updateDriverResponseFromJson(String str) => UpdateDriverResponse.fromJson(json.decode(str));
String updateDriverResponseToJson(UpdateDriverResponse data) => json.encode(data.toJson());
class UpdateDriverResponse {
  ...
  UpdateDriverResponse.fromJson(dynamic json) {
