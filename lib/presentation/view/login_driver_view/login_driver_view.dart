...
class LoginDriverView extends StatefulWidget {
  final TextEditingController numberPhone;
  final TextEditingController password;
  const LoginDriverView(
      {Key? key,
  ...
  @override
  State<LoginDriverView> createState() => _LoginDriverViewState();
}

class _LoginDriverViewState extends State<LoginDriverView> {
            ...
            children: [
                    ...
                    return ButtonFc(
                      onpres: () async {
                        if (key.currentState!.validate()) {
                          await cubit.loginDriver(
                              phone:"$selectedCountryCode${widget.numberPhone.text}",
              ...
              Row(
                ...
                children: [
                  InkWell(
                    onTap: () {
                      Navigator.pushNamed(context, SignUpDriverScreen);
                    },
                    child: Text(
                      'انشاء حساب',
                      style: TextStyle(
