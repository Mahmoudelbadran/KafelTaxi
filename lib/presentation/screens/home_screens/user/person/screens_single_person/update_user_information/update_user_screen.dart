                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                cubit.loginUserResponse.data!.userName,
                                style: TextStyle(
                                    fontSize: 20.sp,
                                    fontWeight: FontWeight.w600,
                                    color: textcolor),
                              ...
                              Text(
                                cubit.loginUserResponse.data!.phone,
                                style: TextStyle(
                                    fontSize: 8.sp,
                                    fontWeight: FontWeight.w600,
                                  ...
                                  child: ButtonFc(
                                    onpres: () {
                                      upDateUser.upDateUser(
                                          token: cubit.loginUserResponse.token,
                                          password: password.text,
                                          email: email.text,
                                          address: address.text,
                                          confirmPassword:
                                              confirmPassword.text);
                                      if(state is LoadingUpDateApiAppState){
                                        Fluttertoast.showToast(
                                            ...
                                            fontSize: 15.sp);
                                      }else if(state is SucessUpDateApiAppState){
                                        Fluttertoast.showToast(
                                            ...
                                            fontSize: 15.sp);
                                        Navigator.pop(context);
                                      }else if(state is ErorrUpDateApiAppState){
                                        Fluttertoast.showToast(
                                            msg: "خطا في البيانات",
                                            toastLength: Toast.LENGTH_SHORT,
                                            gravity: ToastGravity.BOTTOM,
