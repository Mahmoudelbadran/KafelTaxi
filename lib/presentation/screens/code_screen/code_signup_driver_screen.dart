...
class CodeSigInUpDriverScreen extends StatelessWidget {
  const CodeSigInUpDriverScreen({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Padding(
              ...
              child: ButtonFc(onpres:(){
                Navigator.pushNamedAndRemoveUntil(context, screens.ConfirmationDriverScreen, (route) => false);
              },
                Boxcolor: ycolor,
                elevation: 0,
            ...
            Text(" (3:00) اعادة الارسال بعد",style: TextStyle(fontSize: 10.sp,color: textcolor.withOpacity(0.5)),)
