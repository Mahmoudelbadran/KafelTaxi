...
class CodeLoginUserScreen extends StatelessWidget {
  const CodeLoginUserScreen({Key? key}) : super(key: key);
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: ButtonFc(onpres:(){
                Navigator.pushNamedAndRemoveUntil(context, screens.HomeUserScreen, (route) => false);
              },
                Boxcolor: ycolor,
                elevation: 0,
